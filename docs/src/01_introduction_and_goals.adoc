...
| Reliability | The system should be reliable and diverse in generating questions form Wikidata, avoiding bad or unrelated distractors. AI hint system should be accurate and allucinations should be minimized. The system shall handle user registrations, logins, game data storage and gameplay with an error rate of less than 1%.
...
| Security | Users' personal data and authentication details should be securely stored and protected against unauthorized access. API requests should be encrypted.
...
| Maintainability | The architecture should allow developers to easily add new game modes, AI features, or question sources without major system refactoring.
|===
