...
| Client - Professors (Evaluator) | Pablo González González - gonzalezgpablo@uniovi.es, Jose Emilio Labra Bayo - labra@uniovi.es, Irene Cid Rico - cidirene@uniovi.es | They expect a well-structured architectural document, clear software design decisions, and a properly implemented system.
